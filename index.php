          ...
          <div class="col-lg-7 my-auto">
            <div class="header-content mx-auto">
             <!--<a><img class="imglogo" src="http://1.bp.blogspot.com/-GymS21OLL0Y/T71FsGL6QSI/AAAAAAAACnM/d-mBM-eYXKs/s1600/PROGRAMA+G%C3%81S+LEGAL.jpg"></a>  
              ...
              <br>                
              <a href="#" class="btn btn-outline btn-xl js-scroll-trigger" data-toggle="modal" data-target="#exampleModal">Realize a sua denuncia!!</a>
              <br><br>                
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 mx-auto">
            <h2 class="section-heading">Baixe o aplicativo</h2>
            <p></p>
            <div class="badges">
...
<!-- Modal -->
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"  ng-controller="MarkersEventsAddController">
